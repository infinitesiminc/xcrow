...
const ROLE_NPC_AVATAR_POOL: Record<string, string[]> = {
  "Technical": [roleNpcTechnical, roleNpcTechnicalV2, roleNpcTechnicalV3],
  "Analytical": [roleNpcAnalytical, roleNpcAnalyticalV2],
  "Creative": [roleNpcCreative, roleNpcCreativeV2],
  "Strategic": [roleNpcStrategic, roleNpcStrategicV2],
  "Communication": [roleNpcCommunication, roleNpcCommunicationV2],
  "Leadership": [roleNpcLeadership, roleNpcLeadershipV2],

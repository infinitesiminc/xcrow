      ...
      <AnimatePresence>
        {!isOpen && (
          <motion.button
            ...
            className="fixed bottom-4 right-4 z-[60] flex items-center gap-2 px-4 py-2.5 rounded-full bg-card/95 backdrop-blur-xl border border-primary/40 shadow-[0_0_20px_-4px_hsl(var(--primary)/0.5),0_0_40px_-8px_hsl(var(--primary)/0.25)] hover:shadow-[0_0_28px_-4px_hsl(var(--primary)/0.7),0_0_50px_-8px_hsl(var(--primary)/0.35)] transition-all group animate-pulse-glow"
          >

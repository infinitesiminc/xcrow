    ...
    try {
      ...
      if (masteryTier === "silver") {
        setSession({
          ...
          systemPrompt: "",
          openingMessage: "",
          briefing: `**Apprentice — Prompt Forge**\n\nLearn prompting techniques through guided templates and before/after comparisons. See what works and why.`,
          tips: ["Watch how small prompt changes create big output differences", "Copy patterns you can reuse in your own work"],
          learningObjectives: [],
      ...
      // Platinum tier → DelegationSim handles its own flow
        ...
        setSession({
          ...
          systemPrompt: "",
          openingMessage: "",
          briefing: `**Commander — Mission Control**\n\nOversee autonomous AI agents executing "${taskName}". Monitor for anomalies, chain tools into workflows, and prove your leadership.`,
          tips: ["Watch for subtle data errors between agent handoffs", "False alarms cost you — intervene wisely"],
          learningObjectives: [],
          scenario: { id: crypto.randomUUID(), title: taskName, description: `${taskName} for ${jobTitle}`, slug: "dynamic" },
          level: 1,

    ...
    <>
      <header className="sticky top-0 z-50 w-full border-b border-border/50 bg-background/80 backdrop-blur-xl">
        <div className="mx-auto flex h-14 max-w-7xl items-center justify-between px-4 sm:px-6">
          ...
          >
            <div className="h-9 w-9 rounded-xl flex items-center justify-center" style={{ backgroundImage: "linear-gradient(135deg, hsl(270 80% 55%), hsl(330 90% 55%), hsl(180 90% 50%))" }}>
              <img src={crowLogo} alt="Crowy.ai" className="h-7 w-7 object-contain" />
            </div>

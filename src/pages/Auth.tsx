...
const Auth = () => {
  ...
  return (
    <>
      <SEOHead title={isSignUp ? "Create Account" : "Sign In"} description="Sign in to Xcrow to start generating B2B leads." path="/auth" />
          ...
          <Card>
            <CardContent className="p-6">
              <div className="flex items-center gap-2 mb-4">
                ...
                <span className="text-lg font-bold text-foreground tracking-tight">Xcrow</span>
              </div>
              ...
              <p className="text-sm text-muted-foreground mb-6">
                {isSignUp ? "Start generating qualified leads" : "Sign in to your lead gen dashboard"}
              </p>

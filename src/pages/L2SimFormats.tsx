...
function RedTeamFormat() {
  return (
    <GuidedAudit
      ...
      aiOutputSummary="Campaign ROAS dropped 23% week-over-week. Primary driver: paid social CPM increased 18% while conversion rates held steady."
      aiAutoAction="AI will execute budget shift at midnight unless overridden."
    />
  );
}

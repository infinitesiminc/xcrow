                          ...
                          {row.map((role, i) => (
                            ...
                            >
                              <div className="relative overflow-hidden rounded-xl aspect-[4/3] mb-2.5">
                                <img src={role.image} alt={role.title} className="w-full h-full object-cover transition-all duration-300 group-hover:scale-105 saturate-[0.3] brightness-105 hue-rotate-[200deg]" />

      ...
      <AnimatePresence>
        {!chatOpen && (
          <motion.button
            ...
            className="fixed bottom-16 right-4 z-20 flex items-center gap-2 px-4 py-2.5 rounded-lg bg-card/90 backdrop-blur-md border border-border/50 text-sm font-medium text-foreground shadow-lg hover:shadow-xl transition-all active:scale-[0.97]"
          >

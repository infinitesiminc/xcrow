                  ...
                  {tier.roles.map((role, i) => (
                    ...
                    >
                      <div className="relative overflow-hidden rounded-xl aspect-[4/3] mb-2">
                        <img src={role.image} alt={role.title} className="w-full h-full object-cover transition-transform duration-300 group-hover:scale-105 opacity-50 group-hover:opacity-70 saturate-[0.3] group-hover:saturate-[0.6] transition-all" />

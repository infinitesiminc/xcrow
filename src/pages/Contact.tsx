    ...
    <div className="min-h-screen bg-background">
      <div className="mx-auto max-w-4xl px-4 py-16">
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-12">
          {[
            { icon: Mail, title: "Email", detail: "hello@infinitesim.co", sub: "We respond within 24 hours" },
            { icon: MessageSquare, title: "Support", detail: "help@infinitesim.co", sub: "For account & technical issues" },

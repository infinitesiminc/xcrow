...
export const InviteEmail = ({
  ...
  <Html lang="en" dir="ltr">
    <Head />
    <Preview>You've been invited to join Xcrow</Preview>
    <Body style={main}>
      <Container style={container}>
        ...
        <Text style={text}>
          Someone on your team has invited you to join{' '}
          <Link href={siteUrl} style={link}><strong>Xcrow</strong></Link>.
          Accept the invitation below to create your account and start finding leads.
        </Text>
